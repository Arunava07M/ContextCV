    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fcfcfc] font-sans">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-[#eeeeee] rounded-sm p-8">
          <h1 className="text-xl font-medium text-[#444444] mb-1">Login</h1>
          <p className="text-sm text-[#9b9b9b] mb-8">Welcome back to your vault</p>
          ...
          <p className="text-sm text-[#9b9b9b] mt-6 text-center">
            ...
            <Link to="/signup" className="text-[#387ed1] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
